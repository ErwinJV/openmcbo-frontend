...
export default function LastPosts() {
  return (
    <FadeIn>
      <section className="bg-white flex flex-col md:h-screen ">
        <h2 className="text-[#003593] font-bold text-3xl md:text-4xl lg:text-5xl my-10 text-center">
          Ultimas Publicaciones
        </h2>
        <div className="container mx-auto grid grid-flow-col grid-cols-1 lg:grid-cols-2 grid-rows-2 gap-4 h-109 md:h-screen px-6 md:px-8  ">
          <Link
